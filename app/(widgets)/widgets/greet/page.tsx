        ...
        >
            <div className="w-full max-w-md">
                ...
                <div className="relative">
                    {/* 글로우 효과 */}
                    <div
                        className="absolute -inset-1 bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 rounded-3xl blur-lg opacity-60 animate-pulse"/>

                    {/* 카드 본체 */}
                    <div
                        className="relative bg-slate-900/90 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
                        {/* 이모지 애니메이션 */}
