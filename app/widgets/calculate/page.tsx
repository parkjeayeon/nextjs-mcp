...
export default function CalculateWidget() {
  ...
  const operationConfig: Record<string, { gradient: string; emoji: string; label: string }> = {
    add: {
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="relative">
          {/* 글로우 효과 */}
          <div className={`absolute -inset-1 bg-gradient-to-r ${config.gradient} rounded-3xl blur-lg opacity-60`} />
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10">
            ...
            <div className={`bg-gradient-to-r ${config.gradient} p-4`}>
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-white font-bold text-xl">{config.label}</span>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center items-center gap-4">
                <div className="text-center">
                  ...
                  <span className="text-xs text-slate-500 uppercase tracking-wider">첫 번째</span>
                </div>
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs text-slate-500 uppercase tracking-wider">두 번째</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <p className="text-center text-slate-500 text-sm mt-6">
          MCP Tool: <code className="bg-slate-800/50 px-2 py-1 rounded">calculate</code>
        </p>
      </div>
    </div>
  );
